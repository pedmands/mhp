...
/***/ function(module, exports, __webpack_require__) {
	...
	window.renderSerial = function (targetElement) {
	  return _reactDom2.default.render(_react2.default.createElement(_serialPlayer2.default, null), targetElement);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var serialUrl = 'https://soundcloud.com/markhphillips/sets/original-score-from-serial-mark-h-phillips';
	...
	var CustomPlayer = function (_React$Component) {
	    ...
	    _createClass(CustomPlayer, [{
	        ...
	        value: function render() {
	            ...
	            var trackTitle = activeTrack.title.substring(0, activeTrack.title.length - 35);
	...
	var SerialPlayer = function (_Component) {
	    _inherits(SerialPlayer, _Component);

	    function SerialPlayer() {
	        _classCallCheck(this, SerialPlayer);

	        return _possibleConstructorReturn(this, (SerialPlayer.__proto__ || Object.getPrototypeOf(SerialPlayer)).apply(this, arguments));
	    }

	    _createClass(SerialPlayer, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                _addons.SoundPlayerContainer,
	                _extends({ resolveUrl: serialUrl, clientId: clientId }, this.props),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clientId = '08f79801a998c381762ec5b15e4914d5';
	var straysUrl = 'https://soundcloud.com/markhphillips/sets/strays-soundtrack';
	...
	var StraysPlayer = function (_Component) {
	    _inherits(StraysPlayer, _Component);

	    function StraysPlayer() {
	        _classCallCheck(this, StraysPlayer);

	        return _possibleConstructorReturn(this, (StraysPlayer.__proto__ || Object.getPrototypeOf(StraysPlayer)).apply(this, arguments));
	    }

	    _createClass(StraysPlayer, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                _addons.SoundPlayerContainer,
